    ...
    return <>
        <div className="container my-5">
            <div className="col-md-12">
                <a className="add p-2 btn text-white bg-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"><i className="fas fa-plus-circle"></i> Add
                    New</a>
            </div>
        </div>
        ...
        <div className="container text-dark">
            <div className="row">
                {
                    notes?.map((note, index) => {
                        return ( 
                            <div key={note._id} className="col-md-3 my-4 overflow-hidden">
                                <div className="note p-4 bg-light rounded shadow">
            ...
            {notes?.length ===0 && <div className='row'>
               <h2 className='text-center text-white'>No Notes Found!</h2>
            </div>}
        </div>
